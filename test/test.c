...
CTEST(knight, black_move)
{
    ...
    ASSERT_EQUAL(0, Knight(board, 0, 0, 1, 1, '-'));
}

CTEST(knight, black_wrong_figure)
{
    char board[8][8] = {{'n', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
    ...
    ASSERT_EQUAL(1, Knight(board, 1, 1, 2, 2, '-'));
}
CTEST(knight, black_wrong_move_attack)
{
    char board[8][8] = {{' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', 'n', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
    ...
    ASSERT_EQUAL(2, Knight(board, 1, 1, 2, 2, 'x'));
}
CTEST(knight, black_attacking_team)
{
    char board[8][8] = {{' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', 'n', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', ' ', 'p', ' ', ' ', ' ', ' ', ' '},
    ...
    ASSERT_EQUAL(3, Knight(board, 1, 1, 2, 2, 'x'));
}
CTEST(knight, black_wrong_move_clean)
{
    char board[8][8] = {{' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', 'n', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', ' ', 'Q', ' ', ' ', ' ', ' ', ' '},
    ...
    ASSERT_EQUAL(4, Knight(board, 1, 1, 2, 2, '-'));
}
CTEST(knight, black_attack)
{
    char board[8][8] = {{' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', 'n', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', ' ', 'Q', ' ', ' ', ' ', ' ', ' '},
    ...
    ASSERT_EQUAL(0, Knight(board, 1, 1, 2, 2, 'x'));
}

CTEST(knight, white_move)
{
    char board[8][8] = {{' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', ' ', 'N', ' ', ' ', ' ', ' ', ' '},
    ...
    ASSERT_EQUAL(0, Knightw(board, 2, 2, 3, 3, '-'));
}

CTEST(knight, white_wrong_figure)
{
    char board[8][8] = {{'N', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
    ...
    ASSERT_EQUAL(1, Knightw(board, 1, 1, 2, 2, '-'));
}
CTEST(knight, white_wrong_move_attack)
{
    char board[8][8] = {{' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', 'N', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
    ...
    ASSERT_EQUAL(2, Knightw(board, 1, 1, 2, 2, 'x'));
}
CTEST(knight, white_attacking_team)
{
    char board[8][8] = {{' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', 'N', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', ' ', 'P', ' ', ' ', ' ', ' ', ' '},
    ...
    ASSERT_EQUAL(3, Knightw(board, 1, 1, 2, 2, 'x'));
}
CTEST(knight, white_wrong_move_clean)
{
    char board[8][8] = {{' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', 'N', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', ' ', 'q', ' ', ' ', ' ', ' ', ' '},
    ...
    ASSERT_EQUAL(4, Knightw(board, 1, 1, 2, 2, '-'));
}
CTEST(knight, white_attack)
{
    char board[8][8] = {{' ', ' ', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', 'N', ' ', ' ', ' ', ' ', ' ', ' '},
                        {' ', ' ', 'q', ' ', ' ', ' ', ' ', ' '},
    ...
    ASSERT_EQUAL(0, Knightw(board, 1, 1, 2, 2, 'x'));
}